...
<body class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
    ...
    <div class="login-container max-w-md w-full space-y-8 p-10 relative z-10">
        <div class="text-center">
            <h1 class="brand-logo text-5xl mb-2">Renacer</h1>
        ...
        <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('password.request') }}" class="font-medium text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out">
