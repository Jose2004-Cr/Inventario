...
<body class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
    ...
    <div class="register-container max-w-md w-full space-y-8 p-10 relative z-10">
        ...
        <form id="register-form" class="mt-8 space-y-6">
            ...
            <div class="step" data-step="3">
                ...
                <div class="flex items-center mb-4">
                    <input id="terms" name="terms" type="checkbox" class="h-4 w-4 text-purple-500 focus:ring-purple-400 border-gray-300 rounded">
                    <label for="terms" class="ml-2 block text-sm text-gray-900">
                        Acepto los <a href="#" class="text-purple-500 hover:text-purple-400">términos y condiciones</a>
                    </label>
                </div>
                <div class="flex justify-between">
        ...
        <p class="mt-8 text-center text-sm text-gray-600">
            ...
            <a href="{{ route('login') }}" class="font-medium text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out">
                Inicia sesión aquí
            </a>
        </p>
    </div>
