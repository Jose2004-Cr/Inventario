<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-900 via-purple-900 to-blue-900">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="shrink-0">
                    <a href="{{ route('dashboard') }}" class="flex items-center text-white transition-colors duration-300 hover:text-gray-400">
                        ...
                        <span class="ml-2 text-2xl font-extrabold tracking-wider">Renacer</span>
                    </a>
                </div>
